...
//@Disabled
@Autonomous(name="AutoBlueClose3" ,preselectTeleOp = "MainTeleOp", group="Competition")
public class AutoBlueClose3 extends CommandOpMode {
...
//    private final Pose collectPPGPose = new Pose(16, 83, Math.toRadians(180));
    ...
    private final Pose endParkPose = new Pose(18, 106, Math.toRadians(132));
...
//            shootCloseToSpike2Path, collectPGPArtifactsPath, spike2ToShootPath, shootCloseToSpike1Path, collectPPGArtifactsPath, spike1ToShootPath
