...
//@Disabled
@Autonomous(name="AutoRedClose3" ,preselectTeleOp = "MainTeleOp", group="Competition")
public class AutoRedClose3 extends CommandOpMode {
...
//    private final Pose collectPPGPose = MirrorUtility.mirror(new Pose(16, 83, Math.toRadians(180)));
    ...
    private final Pose endParkPose = MirrorUtility.mirror(new Pose(18, 106, Math.toRadians(132)));
...
//    private final Pose collectPGPPose = MirrorUtility.mirror(new Pose(16, 58, Math.toRadians(180)));
    ...
    private PathChain startToLatchPath, latchToShootClosePath, parkPath;
//            shootCloseToSpike1Path, collectPPGArtifactsPath, spike1ToShootPath, shootCloseToSpike2Path, collectPGPArtifactsPath, spike2ToShootPath, parkPath;
...
//                                ),
                                ...
                                //Move to shoot position and stop intake
//                                new ParallelDeadlineGroup(
//                                        new FollowPathCommand(robot.follower, parkPath, true, 1.0),
