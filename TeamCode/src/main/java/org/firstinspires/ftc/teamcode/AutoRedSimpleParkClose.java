...
public class AutoRedSimpleParkClose extends CommandOpMode {
    ...
    private final Pose endParkPose = MirrorUtility.mirror(new Pose(22, 108, Math.toRadians(135)));
...
//    private final Pose collectPGPPose = new Pose(24, 60, Math.toRadians(180));
    ...
    private PathChain startToLatchPath, latchToShootClosePath, shoottoParkPath,shootCloseToSpike1Path, collectPPGArtifactsPath, spike1ToShootPath, parkPath;
