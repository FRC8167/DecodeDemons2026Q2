...
//@Disabled
@Autonomous(name = "AutoBlueFar6", preselectTeleOp = "MainTeleOp", group = "Competition")
public class AutoBlueFar6 extends CommandOpMode {
...
//    private final Pose collectPGPPose = new Pose(16, 58.5, Math.toRadians(180));
    private final Pose simpleParkPose = new Pose(36, 14, Math.toRadians(180));



    private PathChain rotateToShootPath, shootToGPPSpikePath, eatGPPPath, endGPPToShootPath, parkPath;
//            shootToPGPSpikePath, eatPGPPath, endPGPToShootPath;
