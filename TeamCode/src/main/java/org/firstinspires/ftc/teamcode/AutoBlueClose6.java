...
//@Disabled
@Autonomous(name="AutoBlueClose6" ,preselectTeleOp = "MainTeleOp", group="Competition")
public class AutoBlueClose6 extends CommandOpMode {
...
//            shootCloseToSpike2Path, collectPGPArtifactsPath, spike2ToShootPath,
